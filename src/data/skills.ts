...
const PM007: Skill = {
  ...
  milestone: false,
  evidence: [
    'Baby pushes up onto extended arms and maintains the position for at least 10–15 seconds without assistance',
    'Supports their upper body by bearing weight evenly through both open hands with elbows mostly or fully extended',
    'While propped on extended arms, the baby looks around without losing balance or collapsing'
  ],
  typical_age_months: {
    start: 4,
    end: 6
